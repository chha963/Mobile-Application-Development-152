...
public abstract class MyBaseSearchViewSingleFragment extends MyBaseSingleFragment {
    ...
    @BindView(R.id.searchView_SearchViewSingleFragment)
    protected PersistentSearchView mSearchView;

    @BindView(R.id.searchTintView_SearchViewSingleFragment)
    protected View mSearchTintView;

    // List search result view
    @BindView(R.id.recyclerViewSearchResult_SearchViewSingleFragment)
    ...
    protected void fillResultToRecyclerView(String query) {
