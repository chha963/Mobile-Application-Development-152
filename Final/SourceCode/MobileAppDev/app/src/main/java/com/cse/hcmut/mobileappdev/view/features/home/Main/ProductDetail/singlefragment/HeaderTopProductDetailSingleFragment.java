...
public class HeaderTopProductDetailSingleFragment extends MyBaseSingleFragment {
    ...
    public static final String ARG_PRODUCT = "product_HeaderTopProductDetailSingleFragment";
    ...
    @Bind(R.id.imageViewCatalogueTop_HeaderTopProductDetailSingleFragment)
    ImageView mCatalogueTopImageView;

    @Bind(R.id.imageViewBackTop_HeaderTopProductDetailSingleFragment)
    ImageView mNavigationBackImageView;

    @Bind(R.id.frameLayoutBackTop_HeaderTopProductDetailSingleFragment)
