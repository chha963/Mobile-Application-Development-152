...
import com.cse.hcmut.mobileappdev.adapters.ImageGalleryAdapter;
...
public class ContentBotProductDetailSingleFragment extends MyBaseSingleFragment {
    ...
    @BindView(R.id.recyclerViewHorizontal_ContentBottomProductListDetailSingleFragment)
    MySnappyRecyclerView mHorizontalImageRecyclerView;

    @BindView(R.id.txtViewPhoneNumber_ContentBottomProductDetailSingleFragment)
    TextView mPhoneNumberTextView;

    @BindView(R.id.txtViewAddress_ContentBottomProductDetailSingleFragment)
    TextView mAddressTextView;

    @BindView(R.id.txtViewSeeInMap_ContentBottomProductDetailSingleFragment)
    ...
    private void setupRecyclerView(Context context, MySnappyRecyclerView recyclerView) {
        ...
        recyclerView.setFirstMarginView(0);
        recyclerView.setMarginBetweenViews(mMarginRightGalleryItem / 2);
