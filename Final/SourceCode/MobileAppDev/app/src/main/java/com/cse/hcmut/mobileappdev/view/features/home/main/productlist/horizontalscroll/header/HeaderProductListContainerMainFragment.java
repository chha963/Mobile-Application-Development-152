...
import com.cse.hcmut.mobileappdev.adapters.HeaderTopProductListAdapter;
...
public class HeaderProductListContainerMainFragment extends MyBaseSingleFragment {
    ...
    public static HeaderProductListContainerMainFragment newInstance() {

        Bundle args = new Bundle();

        HeaderProductListContainerMainFragment fragment = new HeaderProductListContainerMainFragment();
    ...
    @BindView(R.id.viewPager_HeaderProductListMainSingleFragment)
    MyViewPager mViewPager;

    @BindView(R.id.circleIndicator_HeaderProductListMainSingleFragment)
    ...
    private void setupWidgets() {
        ...
        mPagerAdapter = new HeaderTopProductListAdapter(
                getActivity(),
