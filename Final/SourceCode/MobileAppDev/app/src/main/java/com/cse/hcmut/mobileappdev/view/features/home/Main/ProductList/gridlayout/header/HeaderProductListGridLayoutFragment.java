...
public class HeaderProductListGridLayoutFragment extends MyBaseSingleFragment {
    ...
    public static final String ARG_COLOR_KEY = "ARG_COLOR_HEADER_PRODUCT_LIST_SECTION_CLICKED_CONTAINER";
    ...
    @Bind(R.id.colorView_HeaderGridLayoutProductList)
    View mColorView;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        int color = getArguments().getInt(ARG_COLOR_KEY);
        setViewColor(color);
    }
