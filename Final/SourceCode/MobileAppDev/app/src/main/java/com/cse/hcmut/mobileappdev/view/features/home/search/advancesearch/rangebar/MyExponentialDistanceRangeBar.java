 ...
 */
public class MyExponentialDistanceRangeBar extends View {
    ...
    public interface OnRangeBarChangeListener {
        ...
        public void onRangeChangeListener(MyExponentialDistanceRangeBar rangeBar, int leftPinIndex,
    ...
    /**
     * A callback allow reverse left / right thumb by horizontal axis
     */

    public interface PinViewFormatter {
    ...
    public static interface OnRangeBarTextListener {
        ...
        public String getPinValue(MyExponentialDistanceRangeBar rangeBar, int tickIndex);
    }
    ...
    private static final int DEFAULT_PIN_COLOR = Color.BLACK;
    ...
    private static final float DEFAULT_EXPANDED_PIN_RADIUS_DP = 30;
    ...
    private MyExponentialDistanceBar mBar;
    ...
    private boolean mIsReverseHorizontalLeftThumb = false;

    private boolean mIsReverseHorizontalRightThumb = false;
    ...
    private PinViewFormatter mPinViewFormatter = null;

    // ---------------------------------------------------------------------------------------------
    // CONSTRUCTORS
    // ---------------------------------------------------------------------------------------------

    public MyExponentialDistanceRangeBar(Context context) {
        super(context);
    }

    public MyExponentialDistanceRangeBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        rangeBarInit(context, attrs);
    }

    public MyExponentialDistanceRangeBar(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (mIsRangeBar) {
            ...
            if (mPinViewFormatter != null) {
                mLeftThumb.setReverseHorizontal(mPinViewFormatter.getIsReverseHorizontalLeftThumb());
            }
        }
        ...
        mRightThumb.init(ctx, yPos, expandedPinRadius, mPinColor, mTextColor, mCircleSize,
                mCircleColor, mMinPinFont, mMaxPinFont, mArePinsTemporary);
        if (mPinViewFormatter != null) {
            mRightThumb.setReverseHorizontal(mPinViewFormatter.getIsReverseHorizontalRightThumb());
        }
        ...
        mBar = new MyExponentialDistanceBar(ctx, marginLeft, yPos, barLength, mTickCount, mTickHeightDP, mTickColor,
                mBarWeight, mBarColor);

        // Initialize thumbs to the desired indices
        if (mIsRangeBar) {
            mLeftThumb.setX(marginLeft + (mLeftIndex / (float) (mTickCount - 1)) * barLength);
            mLeftThumb.setPinValueString(getPinValue(mLeftIndex));
        }
        mRightThumb.setX(marginLeft + (mRightIndex / (float) (mTickCount - 1)) * barLength);
        mRightThumb.setPinValueString(getPinValue(mRightIndex));
    ...
    private void createBar() {
        mBar = new MyExponentialDistanceBar(
                getContext(),
                getMarginLeft(),
                getYPos(),
                getBarLength(),
    ...
    private void releasePin(final PinView thumb) {
        ...
        thumb.setPinValueString(getPinValue(tickIndex));
    ...
    public void setPinViewFormatter(PinViewFormatter pinViewFormatter) {
        this.mPinViewFormatter = pinViewFormatter;
    }

    public void setReverseHorizontalLeftThumb(boolean reverseHorizontalLeftThumb) {
        mIsReverseHorizontalLeftThumb = reverseHorizontalLeftThumb;
    }

    public void setReverseHorizontalRightThumb(boolean reverseHorizontalRightThumb) {
        mIsReverseHorizontalRightThumb = reverseHorizontalRightThumb;
    }
