...
import com.cse.hcmut.mobileappdev.models.adapters.ImageGalleryPagerAdapter;
...
public class GalleryViewPagerActivity extends MyActivity {
    ...
    private static final String EXTRA_GALLERY_IMAGE_URLS =
            "com.cse.hcmut.mobileappdev.view.features.home.Main.ProductDetail.activity.gallery_url_list";

    private static final String EXTRA_SELECTED_INDEX =
            "com.cse.hcmut.mobileappdev.view.features.home.Main.ProductDetail.activity.selected_index";
    ...
    @Bind(R.id.viewPager_GalleryViewPagerActivity)
