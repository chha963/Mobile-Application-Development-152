...
public class TopProductListMainSingleFragment extends MyBaseSingleFragment {
    ...
    @Bind(R.id.imageView_TopProductListSingleFragment)
    ImageView mTopProductImageView = null;

    @Bind(R.id.typeAndNameProduct_TopProductListSingleFragment)
    TextView mTypeAndNameTextView = null;

    @Bind(R.id.shortDescriptionProduct_TopProductListSingleFragment)
    TextView mShortDescriptionTextView = null;

    @Bind(R.id.priceProduct_TopProductListSingleFragment)
