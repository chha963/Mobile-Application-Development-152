...
public class ProductCardListAdapter extends RecyclerView.Adapter<ProductCardListAdapter.ProductCardHolder> {
    ...
    public ProductCardListAdapter(Context context, ArrayList<Product> productList) {
        ...
        mColorPriceText = ResourceUtils.getDefaultColorTabLayout(context);
    }

    public ProductCardListAdapter(Context context, ArrayList<Product> productList, int colorPriceText) {
        mContext = context;
        mProductList = productList;
        mColorPriceText = colorPriceText;
    }
    ...
    protected class ProductCardHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        @Bind(R.id.imageView_ProductCardLayout)
        ImageView mIconImageView;

        @Bind(R.id.txtViewProductName_ProductCardLayout)
        TextView mProductNameTextView;

        @Bind(R.id.txtViewProductDate_ProductCardLayout)
        TextView mProductDateTextView;

        @Bind(R.id.txtViewProductPrice_ProductCardLayout)
        ...
        private void bindHolderFrom(Product product) {
            ...
            mProductPriceTextView.setTextColor(mColorPriceText);
