...
public final class MySnappyRecyclerView extends RecyclerView {
    ...
    private final static int MARGIN_BETWEEN_VIEWS = 12;
    private final static int EXTERNAL_SCROLL = 24;
    private final static int EXTERNAL_CHECK_CENTER = 18;
    ...
    private void setMarginsForChild(View child) {
        ...
        int startMargin = childIndex == 0 ? MARGIN_BETWEEN_VIEWS : 0;
        int endMargin = 0;
...
//        }
    ...
    private View getChildClosestToPosition(int x) {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            int childCenterX = ((int) child.getX() + itemWidth / 2 - EXTERNAL_CHECK_CENTER);
    ...
    private void scrollToTargetView(View child) {
        ...
        View lastChild2 = getLayoutManager().getChildAt(getChildCount() - 2);
    ...
    private int getScrollDistance(View child) {
        ...
        return childCenterX - centerX - EXTERNAL_SCROLL;
    }
    ...
    public void scrollLayoutToPosition(int position) {
        ...
        if (layoutManager instanceof LinearLayoutManager) {
            ...
            if (position != 0) {
                ll.scrollToPositionWithOffset(position, MARGIN_BETWEEN_VIEWS);
            } else {
                int orientation = ll.getOrientation();
                switch (orientation) {
                    case VERTICAL:
                        smoothUserScrollBy(0, MARGIN_BETWEEN_VIEWS);
                        break;
                    case HORIZONTAL:
                        smoothUserScrollBy(MARGIN_BETWEEN_VIEWS, 0);
                        break;
                    default:
                        break;
                }
