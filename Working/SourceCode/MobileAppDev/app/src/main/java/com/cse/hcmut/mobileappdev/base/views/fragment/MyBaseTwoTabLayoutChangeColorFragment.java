...
public abstract class MyBaseTwoTabLayoutChangeColorFragment extends MyBaseSingleFragment implements ObservableScrollViewCallbacks {
    ...
    @Bind(R.id.tabLayoutWidget_TwoTabLayoutChangeColorFragment)
    protected TabLayout mTabLayout;

    @Bind(R.id.flexibleHeaderLayout_TwoTabLayoutFragment)
    View mHeaderView;

    @Bind(R.id.scrollView_TwoTabLayoutChangeColorFragment)
